...
def main():
    ...
    mutate_log_path = os.path.join(ealog_folder, 'mute_log_%s_%s.csv' % (pop_size, n_generations))
    ...
    data_hp1 = CWRU(frq, "1772", hof[0][0], 1, cross)
    data_hp2 = CWRU(frq, "1750", hof[0][0], 1, cross)
    data_hp3 = CWRU(frq, "1730", hof[0][0], 1, cross)
    data_lst = [data_hp1, data_hp2, data_hp3]
